...
<Alert color="warning">Input är under utveckling och bör inte användas ännu. Använd istället Textfield-komponenten.</Alert>
<br />

# Input

`Input` kallas textfält på svenska. Det är ett inmatningsfält som till exempel ger användarna möjlighet att skriva korta texter eller siffror.
...
## Riktlinjer för när du ska använda `Input`

...
När du använder ikon måste du själv ställa in storleken på ikonen. Vi rekommenderar att använda dessa storlekar för [Aksels](https://aksel.nav.no/ikoner) ikoner:

| Storlek på knapp  | Aksels ikon `fontSize`  |
| :---------------- | :---------------------- |
| sm                | 1rem                    |
| md                | 1.5rem                  |
| lg                | 2rem                    |
...
För knappar med endast ikon rekommenderar vi att använda större ikon:

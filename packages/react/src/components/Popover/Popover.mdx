...
// med context
<Popover.Context>
  <Popover.Trigger>Utlösare</Popover.Trigger>
  <Popover>Innehåll</Popover>
</Popover.Context>
...
När du använder `@digdir/designsystemet-react` utökar vi `@types/react-dom` för att acceptera detta.